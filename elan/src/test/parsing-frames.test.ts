...
`
	...
	test('parse Frames - External frame with optional into', () => { 
		...
		assert.equal(html, `<statement class="incomplete" id='ext3' tabindex="0"><top><keyword>external </keyword><field id="ident4" class="empty incomplete" tabindex=0><text></text><placeholder>method</placeholder><completion><pr>method</pr></completion><error></error><help title="The name of the procedure to be called (starting lower-case). Alternatively, a 'dotted-call':  the name of a variable or property, followed by a ''' and the name of the procedure method to call on that 'instance'.">?</help></field>(<field id="args5" class="empty optional valid" tabindex=0><text></text><placeholder>arguments</placeholder><completion><pr></pr></completion><error></error><help title="list of zero or more arguments, comma separated. Each argument may be a literal value, variable, or simple expression.">?</help></field>) <field id="into6" class="empty optional valid" tabindex=0><text></text><placeholder>into</placeholder><completion></completion><error></error><help title="Type 'i' put the result of the external method call into a pre-defined variable of a Type able to accept the result.">?</help></field></top></statement>`);
	});
