...
main
  ...
  set ed to source.reduce(ed, lambda d as ImmutableDictionary<of String, Int>, x as String => d.putAtKey(x, 1))
  print ed
end main`;
...
async function main() {
  ...
  ed = _stdlib.reduce(source, ed, (d, x) => _stdlib.putAtKey(d, x, 1));
