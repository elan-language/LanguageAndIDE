...
suite('Parse source and generate Html', () => {
	...
	test('Test Main With All Statements', async () => {
		await assertGeneratesHtmlandSameSource("T03_mainWithAllStatements.elan", "T03_mainWithAllStatements.html");
	});

	test('Test All Globals Except Class', async () => {
		await assertGeneratesHtmlandSameSource("T04_allGlobalsExceptClass.elan", "T04_allGlobalsExceptClass.html");
	});
	...
	test('Test Select Main By Id', async () => {
		await assertEffectOfAction("T03_mainWithAllStatements.elan", SelectMainById, "T07_mainSelected.html",);
	});

	test('Test Select Statement By Id', async () => {
		await assertEffectOfAction("T03_mainWithAllStatements.elan", SelectStatementById, "T07_statementSelected.html",);
	});
	...
	test('CollapseAll', async () => {
		...
		await assertEffectOfAction("T03_mainWithAllStatements.elan", CollapseAll, "T08_collapseAll.html");
	});
});
