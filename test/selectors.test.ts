...
suite("Selector tests", () => {
  ...
  test("Selection Filtering - statements", () => {
    ...
    let help = s.getCompletion();
    assert.equal(help, " call for if constant set throw try variable while comment");
    s.processKey(key("t"));
    help = s.getCompletion();
  ...
  test("Selection Context - in a Function", () => {
    ...
    assert.equal(help, " for if constant set throw try variable while comment");
  });
  ...
  test("Selection Context - in a Test", () => {
    ...
    const help = s.getCompletion();
    assert.equal(help, " assert for if constant set throw try variable while comment");
  });
  ...
  test("Selection Context - deeper nesting 1", () => {
    ...
    const help = s.getCompletion();
    assert.equal(help, " for if constant set throw try variable while comment"); //no else, call
  });
  ...
  test("Selection Context - deeper nesting 2", () => {
    ...
    const help = s.getCompletion();
    assert.equal(help, " elif else for if constant set throw try variable while comment"); //else, but no call
  });
  test("Selection Context - in an IfThen", () => {
    ...
    const help = s.getCompletion();
    assert.equal(help, " call elif else for if constant set throw try variable while comment");
  });
