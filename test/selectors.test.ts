...
suite("Selector tests", () => {
  ...
  test("Selection Filtering - globals", () => {
    ...
    assert.equal(
      g.renderAsHtml(),
      `<el-global class="none" id='select1' tabindex="-1" title="Right-mouse-click or Ctrl-m to show context menu"><el-select><el-txt>c</el-txt><el-place>new code</el-place><div class="options"> constant class</div></el-select></el-global>`,
    );
  });
  ...
  test("Selection Filtering - members", () => {
    ...
    assert.equal(
      s.renderAsHtml(),
      `<el-member class="ok" id='select5' tabindex="-1" title="Right-mouse-click or Ctrl-m to show context menu"><el-select><el-txt>private pro</el-txt><el-place>new code</el-place><div class="options"> property procedure</div></el-select></el-member>`,
    );
  });
  ...
  test("Selection Filtering - abstract class", () => {
    ...
    assert.equal(
      s.renderAsHtml(),
      `<el-member class="ok" id='select5' tabindex="-1" title="Right-mouse-click or Ctrl-m to show context menu"><el-select><el-txt>abstract pro</el-txt><el-place>new code</el-place><div class="options"> property procedure</div></el-select></el-member>`,
    );
  });
  ...
  test("Selection Filtering - statements", () => {
    ...
    assert.equal(
      s.renderAsHtml(),
      `<el-statement class="ok" id='select3' tabindex="-1" title="Right-mouse-click or Ctrl-m to show context menu"><el-select><el-txt>t</el-txt><el-place>new code</el-place><div class="options"> throw try</div></el-select></el-statement>`,
    );
  });
