...
suite("Selector tests", () => {
  ...
  test("Selection Filtering - members", () => {
    ...
    assert.equal(
      s.renderAsHtml(),
      `<el-member class="ok" id='select5' tabindex="0" title="Right-mouse-click or Ctrl-m to show context menu"><el-select><el-txt>private pro</el-txt><el-place>new code</el-place><el-help class="selector"> procedure property</el-help></el-select></el-member>`,
    );
  });
  ...
  test("Selection Filtering - abstract class", () => {
    ...
    assert.equal(
      s.renderAsHtml(),
      `<el-member class="ok" id='select5' tabindex="0" title="Right-mouse-click or Ctrl-m to show context menu"><el-select><el-txt>abstract pro</el-txt><el-place>new code</el-place><el-help class="selector"> procedure property</el-help></el-select></el-member>`,
    );
  });
