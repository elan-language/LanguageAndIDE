...
static void main() {
  ...
  print(String.format("Game Over! Score: %", snake.score())); // call procedure
}
...
class Snake {
  ...
  private Direction currentDir; // property
  private Square head; // property
  private List<Square> body; // property
  private Square priorTail; // property
