...
def sortedFrontHalf(li: list[str]) -> list[str]: # function
  ...
  frontHalf = li.subList(0, mid) # variable definition
  return sort(frontHalf)
# end function

def sortedBackHalf(li: list[str]) -> list[str]: # function
  mid = divAsInt(li.length(), 2) # variable definition
  backHalf = li.subList(mid, li.length()) # variable definition
  return sort(backHalf)
# end function

def merge(a: list[str], b: list[str]) -> list[str]: # function
  oneIsEmpty = (a.length() == 0) or (b.length() == 0) # variable definition
  return if_(oneIsEmpty, a.withAppendList(b), mergeNonEmpty(a, b))
# end function

def mergeNonEmpty(a: list[str], b: list[str]) -> list[str]: # function
  aHead = a.head() # variable definition
  bHead = b.head() # variable definition
  aTail = a.tail() # variable definition
  bTail = b.tail() # variable definition
...
class Test_sort(unittest.TestCase):
 def test_sort(self) -> None:
  # Edge case: empty
  l1 = list[str]() # variable definition
...
class Test_sortedFrontHalf(unittest.TestCase):
 def test_sortedFrontHalf(self) -> None:
  ...
  li1 = ["plum"] # variable definition
  self.assertEqual(sortedFrontHalf(li1), list[str]())
  # Happy case: odd number of members
  li2 = ["plum", "apricot", "lime", "lemon", "melon", "apple", "orange", "strawberry", "pear"] # variable definition
  self.assertEqual(sortedFrontHalf(li2), ["apricot", "lemon", "lime", "plum"])
  # Happy case: even number of members
  li3 = ["plum", "apricot", "lemon", "melon", "apple", "orange", "strawberry", "pear"] # variable definition
  self.assertEqual(sortedFrontHalf(li3), ["apricot", "lemon", "melon", "plum"])
  # Edge case: already sorted
  li4 = ["apple", "apricot", "lemon", "lime", "melon", "orange", "pear"] # variable definition
...
class Test_merge(unittest.TestCase):
 def test_merge(self) -> None:
  ...
  le = list[str]() # variable definition
  ...
  lu = ["lime", "pear", "apple"] # variable definition
