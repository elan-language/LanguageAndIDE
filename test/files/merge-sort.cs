...
[TestMethod] static void test_sort() {
  ...
  var li3 = new [] {"plum", "apricot", "lime", "lemon", "melon", "apple", "orange", "strawberry", "pear"};
  var sorted3 = new [] {"apple", "apricot", "lemon", "lime", "melon", "orange", "pear", "plum", "strawberry"};
  Assert.AreEqual(sorted3, sort(li3));
  // Happy case: even number of members
  var li4 = new [] {"plum", "apricot", "lime", "lemon", "melon", "apple", "orange", "strawberry"};
  var sorted4 = new [] {"apple", "apricot", "lemon", "lime", "melon", "orange", "plum", "strawberry"};
  Assert.AreEqual(sorted4, sort(li4));
  // Edge case: already sorted
  var li5 = new [] {"apple", "apricot", "lemon", "lime", "melon", "orange", "pear", "strawberry"};
...
[TestMethod] static void test_sortedFrontHalf() {
  ...
  // Happy case: odd number of members
  var li2 = new [] {"plum", "apricot", "lime", "lemon", "melon", "apple", "orange", "strawberry", "pear"};
  Assert.AreEqual(new [] {"apricot", "lemon", "lime", "plum"}, sortedFrontHalf(li2));
  // Happy case: even number of members
  var li3 = new [] {"plum", "apricot", "lemon", "melon", "apple", "orange", "strawberry", "pear"};
  Assert.AreEqual(new [] {"apricot", "lemon", "melon", "plum"}, sortedFrontHalf(li3));
  // Edge case: already sorted
  var li4 = new [] {"apple", "apricot", "lemon", "lime", "melon", "orange", "pear"};
...
[TestMethod] static void test_merge() {
  // Happy cases:
  var l1 = new [] {"apple", "lime", "pear"};
  var l2 = new [] {"apricot", "lemon", "plum", "watermelon"};
