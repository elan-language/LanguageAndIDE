...
`;
    ...
    assertStatusIsValid(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Incompatible types. Expected: List<of String> Provided: List<of Int>. <u>More Info</u>",
    ]);
  });
...
`;
    ...
    assertStatusIsValid(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Incompatible types. Expected: List<of Int> Provided: Int. <u>More Info</u>",
    ]);
  });
...
`;
    ...
    assertStatusIsValid(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Incompatible types. Expected: ListImmutable<of Int> Provided: List<of Int>. <u>More Info</u>",
    ]);
  });
...
`;
    ...
    assertStatusIsValid(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Incompatible types. Expected: ListImmutable<of String> or List<of String> Provided: List<of Int>. <u>More Info</u>",
    ]);
  });
