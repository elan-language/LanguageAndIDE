...
main
  print maxInt(source)
    ...
    assertDoesNotCompile(fileImpl, [
      "Argument types. Expected: listOfInt (List<of Int>) Provided: ListImmutable<of Int>. <u>More Info</u>LangRef.html#compile_error",
    ]);
  });
...
main
  ...
  print minInt(source)
    ...
    assertParses(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Argument types. Expected: listOfInt (List<of Int>) Provided: List<of Float>. <u>More Info</u>LangRef.html#compile_error",
    ]);
  });
...
main
  ...
  print maxInt(source)
    ...
    assertParses(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Argument types. Expected: listOfInt (List<of Int>) Provided: List<of String>. <u>More Info</u>LangRef.html#compile_error",
    ]);
  });
...
main
  print source.maxBy(lambda t as String => t)
    ...
    assertParses(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Argument types. Expected: lambdaOrFunctionRef (Func<of String => Float>) Provided: Func<of String => String>. <u>More Info</u>LangRef.html#compile_error",
    ]);
  });
...
main
  print source.keys.map(lambda s as String => s)
    ...
    assertParses(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "To evaluate function 'keys' add brackets. <u>More Info</u>LangRef.html#compile_error",
    ]);
  });
});
