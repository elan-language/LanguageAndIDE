...
main
  variable vg set to new List<of VectorGraphic>()
  variable circ set to new CircleVG()
  assign circ to circ.withRadius(20)
  assign circ to circ.withCentreX(30)
  assign circ to circ.withCentreY(40)
  assign circ to circ.withFillColour(blue)
  assign circ to circ.withStrokeColour(yellow)
  assign circ to circ.withStrokeWidth(2)
  assign vg to vg.withAppend(circ)
  variable line set to new LineVG()
  assign line to line.withX1(10)
  assign line to line.withY1(15)
  assign line to line.withX2(20)
  assign line to line.withY2(30)
  assign line to line.withStrokeColour(blue)
  assign line to line.withStrokeWidth(3)
  assign vg to vg.withAppend(line)
  variable rect set to new RectangleVG()
  assign rect to rect.withX(10)
  assign rect to rect.withY(15)
  assign rect to rect.withWidth(20)
  assign rect to rect.withHeight(30)
  assign rect to rect.withFillColour(green)
  assign rect to rect.withStrokeColour(blue)
  assign rect to rect.withStrokeWidth(3)
  assign vg to vg.withAppend(rect)
  call printNoLine(vg.vectorGraphicsAsHtml())
end main`;
...
main
  ...
  assign i to i.withX(50).withY(50).withWidth(50).withHeight(50)
  call vg.append(i)
  call printNoLine(vg.vectorGraphicsAsHtml())
end main`;
