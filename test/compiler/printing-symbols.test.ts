...
main
  let i be new Image("https://elan-language.github.io/LanguageAndIDE/images/Debug.png") with width set to 50, height set to 50
  print i
end main`;
