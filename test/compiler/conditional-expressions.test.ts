...
main
 ...
 print a
    ...
    assertStatusIsValid(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Cannot determine common type between Int and String. <u>More Info</u>",
    ]);
  });
...
class Bar
    ...
    assertStatusIsValid(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Incompatible types. Expected: Bar Provided: Foo. <u>More Info</u>",
    ]);
  });
...
class Bar
    ...
    assertStatusIsValid(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Cannot determine common type between Foo and Bar. <u>More Info</u>",
    ]);
  });
