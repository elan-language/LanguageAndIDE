...
function foo(arr as List<of List<of Int>>) returns List<of List<of Int>>
  return bar(arr)
    ...
    assertDoesNotCompile(fileImpl, [
      "Argument types. Expected: arr (List<of List<of Int>>) Provided: Array2D<of Int>. <u>More Info</u>",
    ]);
  });
...
`;
    ...
    assertParses(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Missing argument(s). Expected: column (Int), row (Int), value (String). <u>More Info</u>",
    ]);
  });
...
`;
    ...
    assertParses(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Argument types. Expected: column (Int), row (Int), value (String) Provided: Int, Int, Boolean. <u>More Info</u>",
    ]);
  });
...
main
  ...
  print a
    ...
    assertParses(fileImpl);
    assertDoesNotCompile(fileImpl, ["Cannot index Array2D<of String>. <u>More Info</u>"]);
  });
...
main
  ...
  print a
    ...
    assertParses(fileImpl);
    assertDoesNotCompile(fileImpl, [
      "Argument types. Expected: columns (Int), rows (Int), initialValue (Generic Parameter T1) Provided: Int, Int, String. <u>More Info</u>",
      "<of Type(s)> Expected: 1 Provided: 0. <u>More Info</u>",
    ]);
  });
