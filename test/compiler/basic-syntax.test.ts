...
`;
    ...
    assertDoesNotCompileWithId(fileImpl, "print3", [
      "To evaluate function 'foo' add brackets. Or to create a reference to 'foo', precede it by 'ref'. <u>More Info</u>LangRef.html#compile_error",
    ]);
  });
...
main
  # [unknownDirective]
    ...
    assertDoesNotCompile(fileImpl, [
      "a comment may not start with [ unless it is a recognised compiler directive. <u>More Info</u>LangRef.html#compile_error",
    ]);
  });
