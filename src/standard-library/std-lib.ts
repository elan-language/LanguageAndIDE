...
export class StdLib {
  ...
  arrayAsListImmutable<T1>(@elanClassType(List) arr: List<T1>): ListImmutable<T1> {
    const list = [...arr];
  ...
  listImmutableAsArray<T1>(@elanClassType(ListImmutable) list: ListImmutable<T1>): List<T1> {
    const newList = [...list];
