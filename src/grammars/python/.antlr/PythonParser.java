...
public class PythonParser extends Parser {
	...
	public static final int
		...
		THIS_INSTANCE=68, ABSTRACT_METHOD=69, ASSERT_EQUAL=70, AS=71, DEF=72, 
		CLASS=73, ELIF=74, ELSE=75, EXCEPT=76, FOR=77, IF=78, IN=79, INIT=80, 
		INPUT=81, LAMBDA=82, MAIN=83, NONE=84, PASS=85, PRINT=86, RAISE=87, RETURN=88, 
		TRY=89, WHILE=90, ABC=91, ENUM=92, TESTCASE=93, POWER=94, TUPLE=95, IF_=96;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			null, null, null, null, null, null, "'#'", "'int'", "'float'", "'bool'", 
			"'str'", "'list'", "'Callable'", "'True'", "'False'", "'and'", "'or'", 
			"'not'", "'=='", "'!='", "'%'", "'->'", "'0b'", "'0x'", "'f'", "'self'", 
			"'@abstractmethod'", "'assertEqual'", "'as'", "'def'", "'class'", "'elif'", 
			"'else'", "'except'", "'for'", "'if'", "'in'", "'__init__'", "'input'", 
			"'lambda'", "'main'", "'None'", "'pass'", "'print'", "'raise'", "'return'", 
			"'try'", "'while'", "'ABC'", "'Enum'", "'unittest.TestCase'", "'**'", 
			"'tuple'", "'if_'"
		};
	}
	...
	public final FileContext file() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMENT || _la==NAME_STARTING_LC || _la==DEF || _la==CLASS) {
				{
				{
				setState(155);
				global();
	...
	public final FunctionContext function() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 251075681356611746L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 14158851L) != 0)) {
				{
				setState(212);
				_errHandler.sync(this);
	...
	public final PrintContext print() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1440025982982430880L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 805306371L) != 0)) {
				{
				setState(345);
				expression(0);
				}
	...
	public final MethodCallContext methodCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1440025982982430880L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 805339139L) != 0)) {
				{
				setState(757);
				argList();
				}
