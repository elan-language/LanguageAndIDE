# 7dc28a14dda0f54fa7372f1f0ad43f2f2f4554b66971fa3c0a3b756becb31a99 Elan 1.9.0 guest default_profile valid
...
def main -> None:  # [main]
  ...
  for i in range(1, 20, 1):  # [for loop]
    c = new CircleVG() with centreX set to i*5 + 2, centreY set to 75, radius set to 1, fillColour set to transparent, strokeColour set to randomInt(black, white) # [variable definition]
    bubbles.append(c) # [call procedure]}
  while true
