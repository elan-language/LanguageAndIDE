# f3f6b276a5ed5be2dbee11f10e7739528f992aea06f94db53314bc04c3d88720 Elan 1.9.0 guest default_profile valid
...
def main -> None:  # [main ]
  ...
  for count in range(1, 20, 1): <el-comment> # [for loop ]</el-comment>
...
def circle(t: Turtle, radius: Int) -> None:  # [procedure ]}
  ...
  for count in range(1, 360, 1): <el-comment> # [for loop ]</el-comment>
