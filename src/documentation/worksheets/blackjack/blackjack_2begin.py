# 40278cda12df048f023a7707e355d7aa8e7986d5b35f61cf723741054555a319 Elan 1.9.0 guest default_profile valid

def main -> None:  # [main]
  points = 1000 # [variable definition]
  rounds = 1 # [variable definition]
...
[imported] Action = Enum ('Action', 'stand, draw'})

[imported] Outcome = Enum ('Outcome', 'undecided, lose, draw, win, winDouble'})

[imported] Status = Enum ('Status', 'active, standing, blackjack, bust'})

[imported] Suit = Enum ('Suit', 'clubs, diamonds, hearts, spades'})
