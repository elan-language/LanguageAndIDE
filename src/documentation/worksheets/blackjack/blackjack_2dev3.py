# 01ca4dcbcfd7e3d807e7232a1bfb4f424513f571c57065b2d8ec34858219e2f1 Elan 1.9.0 guest default_profile valid
...
def strategyB(p: Player, dealerFaceUp: Card) -> Action:  # [function]
  act = Action.stand # [variable definition]
  limit = 17 # [variable definition]
  if (dealerFaceUp.value >= 5) and (dealerFaceUp.value <= 6) then
    limit = 12 # [assign variable]
  else if p.hasSoftAce then
    limit = 18 # [assign variable]
