...
${this.renderChildrenAsHtml()}
  ...
  renderAsSource(): string {
    return `${this.indent()}${this.sourceAnnotations()}for ${this.variable.renderAsSource()} in range(${this.from.renderAsSource()}, ${this.to.renderAsSource()}, ${this.step.renderAsSource()}): ${this.annotationAsSource()}\r
