...
<el-top>${this.contextMenu()}${this.bpAsHtml()}<el-expand>+</el-expand><el-comment># TODO convert from repeat loop with condition: '${this.condition.renderAsSource()}'</el-comment><br>
<el-kw>while</el-kw> <el-method>true</el-method>${this.helpAsHtml()}</el-top>${this.getFrNo()}
