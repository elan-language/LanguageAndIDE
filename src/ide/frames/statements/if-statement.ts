...
<el-top>${this.contextMenu()}${this.bpAsHtml()}<el-expand>+</el-expand><el-kw>${ifKeyword} </el-kw>${this.condition.renderAsHtml()}:${this.helpAsHtml()}${this.getFrNo()}</el-top>${this.compileMsgAsHtml()}
