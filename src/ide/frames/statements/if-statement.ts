...
<el-top>${this.contextMenu()}${this.bpAsHtml()}<el-expand>+</el-expand>${this.displayLanguage().renderTopAsHtml(this)}${this.helpAsHtml()}${this.getFrNo()}</el-top>${this.compileMsgAsHtml()}
