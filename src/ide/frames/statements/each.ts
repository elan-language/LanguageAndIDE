...
<el-top>${this.contextMenu()}${this.bpAsHtml()}<el-expand>+</el-expand><el-kw>for </el-kw>${this.variable.renderAsHtml()}<el-kw> in </el-kw>${this.iter.renderAsHtml()}:${this.helpAsHtml()}${this.compileMsgAsHtml()}${this.getFrNo()}</el-top>
