...
<el-top>${this.contextMenu()}${this.bpAsHtml()}<el-expand>+</el-expand><el-kw>while </el-kw>${this.helpAsHtml()}${this.condition.renderAsHtml()}${this.compileMsgAsHtml()}${this.getFrNo()}</el-top>
