...
<top><el-kw>abstract procedure </el-kw><el-method>${this.name.renderAsHtml()}</el-method>(${this.params.renderAsHtml()})</top>${this.compileMsgAsHtml()}${this.getFrNo()}</procedure>
`;
  }
