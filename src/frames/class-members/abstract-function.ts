...
<top><el-kw>abstract function </el-kw><el-method>${this.name.renderAsHtml()}</el-method>(${this.params.renderAsHtml()})<el-kw> return </el-kw>${this.returnType.renderAsHtml()}</top>${this.compileMsgAsHtml()}${this.getFrNo()}</el-func>
`;
  }
